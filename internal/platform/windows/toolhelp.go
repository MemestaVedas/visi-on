...
func (w *WindowsPlatform) WatchProcess(pid int, onChange func(platform.ProcessInfo)) error {
	return nil
}
func (w *WindowsPlatform) WatchDirectory(path string, onChange func(platform.FileEvent)) error {
	return nil
}
